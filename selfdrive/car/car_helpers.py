...
def fingerprint(logcan, timeout):
  ...
  while 1:
    ...
    if len(candidate_cars) == 1 and st is not None:
      ...
      time_fingerprint = 3.0 if ("TOYOTA" in candidate_cars[0] or "LEXUS" in candidate_cars[0]) else 0.1
    ...
    # bail if no cars left or we've been waiting too long
      ...
      #return None, finger
      return 'TOYOTA PRIUS 2017',  {643L: 7, 810L: 2, 870L: 7, 836L: 8, 1568L: 8, 36L: 8, 37L: 8, 166L: 8, 295L: 8, 296L: 8, 170L: 8, 560L: 7, 562L: 6, 180L: 8, 1077L: 8, 951L: 8, 1467L: 8, 829L: 2, 800L: 8, 452L: 8, 581L: 5, 713L: 8, 971L: 7, 845L: 5, 974L: 8, 975L: 5, 466L: 8, 467L: 8, 863L: 8, 608L: 8, 610L: 8, 550L: 8, 742L: 8, 743L: 8, 1132L: 8, 1005L: 2, 552L: 4, 1020L: 8, 426L: 6}
